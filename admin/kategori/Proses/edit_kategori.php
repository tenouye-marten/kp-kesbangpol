...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = $model->updateKategori($id, $kategori);
    if ($result) {
      $_SESSION['message'] = "Data Kategori berhasil diperbaharui.";
...
<head>
  ...
  <title>Dashboard - Edit-Kategori</title>
    ...
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <!-- Vertical Form -->
          <form action="edit_kategori.php" method="post" class="row g-3">
          <input type="hidden" name="id" value="<?php echo $Data['id']; ?>">
           
          <div class="col-12">
              <label for="inputNanme4" class="form-label">Kategori</label>
              <input value="<?= htmlspecialchars($Data['kategori']) ?>" name="kategori" type="text" class="form-control" id="inputNanme4">
            </div>
