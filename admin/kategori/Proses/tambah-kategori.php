...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $result = $model->tambahKategori($kategori);
    if ($result) {
      $_SESSION['message'] = "Data Kategori berhasil ditambah.";
...
<head>
  ...
  <title>Dashboard - Tambah-Kategori</title>
        ...
        <div class="card-body">
          ...
          <form method="post" class="row g-3">
            <div class="col-12">
              ...
              <input required type="text" name="kategori" class="form-control" id="inputNanme4">
            </div>
