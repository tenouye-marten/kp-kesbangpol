    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Data Ormas</li>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
            <a href="proses/tambah-ormas.php" class="btn btn-primary my-4"><i class="bi bi-plus me-1"></i> Tambah </a>
            <?php
...
<td>
  ...
  <ul class="dropdown-menu">
    ...
    <a  href="./proses/edit_ormas.php?id=<?= $ormas['id'] ?>" class="edit-link  dropdown-item">     <i class="bi bi-pencil-square text-warning"></i>Edit</a> </li>
    <li> 
    <a href="./proses/hapus_ormas.php?id=<?= $ormas['id'] ?>" class="delete-link dropdown-item" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">      <i class="bi bi-trash-fill text-danger"></i>Hapus</a>
