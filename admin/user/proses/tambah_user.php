...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['tambah_user'])) {
    ...
    if ($userController->addUser($nama, $email, $password, $alamat, $jenis_kelamin)) {
        $_SESSION['message'] = "Data User berhasil ditambah.";
        header("Location: ../user.php");
    } else {
        echo "Terjadi kesalahan dalam menambah data!";
    }
}
?>
