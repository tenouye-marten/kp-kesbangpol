...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Jan 2025 pada 03.36
...
(2, 'nkjn', 'bayu ss', 'agus ', 'sou', 'nu', 'Aktif', 2);
...
--
ALTER TABLE `tbl_ormas`
  ADD CONSTRAINT `tbl_ormas_ibfk_1` FOREIGN KEY (`id_kategori`) REFERENCES `tbl_kategori` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
