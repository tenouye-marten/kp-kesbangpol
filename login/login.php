...
if (isset($_COOKIE['user_email']) && isset($_COOKIE['user_token'])) {
    ...
    if ($user && hash_equals($token, hash('sha256', $user['password']))) {
        $_SESSION['user'] = $user;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($user && password_verify($password, $user['password'])) {
        ...
        if ($remember) {
            ...
            setcookie('user_email', $email, time() + (1800), '/'); // 30 hari
            setcookie('user_token', $token, time() + (1800), '/');
        }
          ...
          <div class="row justify-content-center">
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <?php if (isset($error)): ?>
                    ...
                    <div class="col-12 ">
                      <p class="small mb-0 mt-4 text-center">Kembali ke <a href="../index.php">Home</a></p>
                    </div>
                  </form>
              ...
              <div class="credits">
                ...
                Designed by <a href="#">Kesbangpol Keerom</a>
              </div>
